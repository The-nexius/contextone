...
(function() {
  ...
  function injectMainWorldInterceptor() {
    ...
    script.src = chrome.runtime.getURL('inject/perplexity-interceptor.js');
    script.onload = function() {
      console.log('Context One: Perplexity MAIN world interceptor loaded');
      script.remove();
    };
    script.onerror = function(e) {
      console.log('Context One: Failed to load perplexity-interceptor, trying generic:', e);
