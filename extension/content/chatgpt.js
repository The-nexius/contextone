// Context One - ChatGPT Content Script (MV3)
...
(function() {
  ...
  // Initialize
  function init() {
    console.log('Context One: Initializing ChatGPT integration (MV3)');
  ...
  function attachToInput() {
    ...
    if (editor && !editor.dataset.contextOneAttached) {
      ...
      console.log('Context One: Attached to ChatGPT input');
    }
  ...
  async function handleSend(message) {
    console.log('Context One: Capturing message for ChatGPT');
