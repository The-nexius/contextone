...
(function() {
  ...
  function injectMainWorldInterceptor() {
    ...
    script.src = chrome.runtime.getURL('inject/gemini-interceptor.js');
    script.onload = function() {
      console.log('Context One: Gemini MAIN world interceptor loaded');
      script.remove();
    };
    script.onerror = function(e) {
      console.log('Context One: Failed to load gemini-interceptor, trying generic:', e);
