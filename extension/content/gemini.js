      ...
      (function() {
        ...
        window.fetch = async function(...args) {
          ...
          if (url.includes('generativelanguage.googleapis.com') || url.includes('gemini.google.com')) {
            console.log('🔍 Context One: Gemini API call:', url);
              ...
              try {
                ...
                if (body.contents && Array.isArray(body.contents)) {
                  body.contents.unshift({
                    role: 'user',
                    parts: [{ text: '[Context]: ' + contextEl.textContent }]
                  });
    ...
    const interceptorCode = `
      (function() {
        ...
        window.fetch = async function(...args) {
          ...
          if (url.includes('generativelanguage.googleapis.com') || url.includes('gemini.google.com')) {
            console.log('🔍 Context One: Gemini API call detected:', url);
            ...
            if (contextEl && contextEl.textContent && options.body) {
              try {
                ...
                if (body.contents && Array.isArray(body.contents)) {
                  ...
                  body.contents.unshift({
                    role: 'user',
                    parts: [{ text: '[Context from other AI conversations]: ' + context }]
                  });
                  options.body = JSON.stringify(body);
                  console.log('✅ Context One: Injected context into Gemini request');
                }
              } catch(e) {
